...
local rotationDeathKnightUnholyDefault = [[
    ...
    or     (((NAG:RemainingTime() >= 15) and (NAG:CurrentTime() > 5) and (NAG:AuraNumStacksPet(91342) == 5.0)) and NAG:Cast(63560))
    or     ((NAG:CurrentTime() >= 5) and NAG:Cast(2825))
    or     (((NAG:AuraIsActiveWithReactionTime(53365) and NAG:AllTrinketStatProcsActive(-1, 6, -1) and (NAG:CurrentTime() >= 5)) or (NAG:TimeToReady(49206) >= 30) or (NAG:RemainingTime() <= 35) or (NAG:IsActive(58146) and (NAG:ItemRemainingTime(84963) < 15)) or (NAG:IsReady(49206) and (NAG:TrinketProcsMinRemainingTime(-1, 6, -1, 60) <= 15))) and NAG:Cast(69002))
    or     (((NAG:AllTrinketStatProcsActive(-1, 6, -1) and (NAG:AuraIsActiveWithReactionTime(53365) or (NAG:TrinketProcsMinRemainingTime(-1, 6, -1, 60) <= 20)) and NAG:IsReady(77575) and (NAG:CurrentTime() >= 5)) or ((NAG:TrinketProcsMinRemainingTime(-1, 6, -1, 60) <= 20) and NAG:IsReady(49206) and (NAG:CurrentTime() >= 5)) or (NAG:RemainingTime() <= 35) or (NAG:IsActive(58146) and (NAG:ItemRemainingTime(84963) <= 20)) or ((NAG:CurrentTime() >= 5) and (NAG:NumEquippedStatProcTrinkets(-1, 6, -1, 110) == 0.0))) and NAG:Cast(62464))
    or     (((NAG:AllTrinketStatProcsActive(-1, 6, -1) and (NAG:AuraIsActiveWithReactionTime(53365) or (NAG:TrinketProcsMinRemainingTime(-1, 6, -1, 60) <= 15)) and (NAG:CurrentTime() >= 5)) or ((NAG:TrinketProcsMinRemainingTime(-1, 6, -1, 60) <= 15) and NAG:IsReady(49206)) or (NAG:RemainingTime() <= 35) or (NAG:IsActive(58146) and (NAG:ItemRemainingTime(84963) <= 15))) and NAG:Cast(77116))
    ...
    or     ((((NAG:AuraIsActiveWithReactionTime(53365) and NAG:AllTrinketStatProcsActive(-1, 6, -1) and (NAG:CurrentTime() >= 5)) or ((NAG:TimeToReady(49206) >= 30)) or (NAG:RemainingTime() <= 35) or (NAG:IsActive(58146) and (NAG:ItemRemainingTime(84963) < 10.5)) or (NAG:IsReady(49206) and (NAG:TrinketProcsMinRemainingTime(-1, 6, -1, 60) < 10.5))) and (not (NAG:IsKnown(69002) or NAG:IsKnown(62464) or NAG:IsKnown(77116)))) and NAG:Cast(82174))
    or     ((((NAG:IsKnown(69002) or NAG:IsKnown(62464) or NAG:IsKnown(77116)) and ((NAG:TimeToReady(69002) > 10) or (NAG:TimeToReady(62464) > 10) or (NAG:TimeToReady(77116) > 10) or ((NAG:TrinketProcsMaxRemainingIcd(-1, 6, -1, 60) > 10) and (NAG:RemainingTime() > 45)))) or (NAG:RemainingTime() <= 35)) and NAG:Cast(82174))
    or     (((NAG:AuraIsActiveWithReactionTime(53365) and NAG:AllTrinketStatProcsActive(-1, 6, -1)) or (NAG:IsActive(58146) and ((NAG:PetAuraRemainingTime(63560) >= 7.5) or (NAG:ItemRemainingTime(84963) < 10.5))) or ((NAG:RemainingTime() < 10.5))) and NAG:Cast(26297))
    ...
    or     (((NAG:AllTrinketStatProcsActive(-1, 6, -1) and (NAG:AuraIsActiveWithReactionTime(53365) or (NAG:TrinketProcsMinRemainingTime(-1, 6, -1, 60) <= 15)) and NAG:IsReady(77575) and (NAG:CurrentTime() >= 5)) or ((NAG:TrinketProcsMinRemainingTime(-1, 6, -1, 60) <= 15) and NAG:IsReady(49206)) or (NAG:RemainingTime() <= 35) or (NAG:IsActive(58146) and (NAG:ItemRemainingTime(84963) <= 15))) and NAG:Cast(33697))
    or     ((((NAG:RemainingTime() <= 35) and ((NAG:TimeToReady(49016) > (NAG:RemainingTime() - 23)) or NAG:IsReady(49206))) or (NAG:IsActive(49016) and (NAG:IsReady(49206) or (NAG:AuraRemainingTime(49016) < 26) or (NAG:PetAuraRemainingTime(63560) >= 24))) or ((NAG:TimeToReady(49206) > (NAG:RemainingTime() - 30)) and NAG:AnyTrinketStatProcsActive(-1, 6, -1, 60))) and NAG:Cast(58146))
    ...
    or     (((NAG:AllTrinketStatProcsActive(-1, 6, -1) and NAG:AuraIsActiveWithReactionTime(53365) and ((NAG:CurrentTime() > 60) or NAG:AuraIsActivePet(63560)) and (NAG:RemainingTime() > 6) and ((not NAG:IsKnown(62464)) or NAG:IsActive(62464) or (NAG:TrinketProcsMinRemainingTime(-1, 6, -1, 60) < (NAG:TimeToReady(62464) - 4.0)))) or ((NAG:TrinketProcsMinRemainingTime(-1, 6, -1, 60) < 4) and NAG:AuraIsActiveWithReactionTime(53365) and (NAG:RemainingTime() > 7)) or (NAG:AllTrinketStatProcsActive(-1, 6, -1) and (NAG:TrinketProcsMinRemainingTime(-1, 6, -1, 60) < 4) and (NAG:RemainingTime() > 7)) or ((NAG:RemainingTime() < 35) and (NAG:RemainingTime() > 7)) or ((NAG:ItemRemainingTime(84963) <= 4) and NAG:IsActive(58146) and (NAG:RemainingTime() > 7)) or ((NAG:AuraRemainingTime(33697) <= 4) and (NAG:AuraRemainingTime(33697) > 0.0) and (NAG:RemainingTime() > 7))) and NAG:Cast(49206))
