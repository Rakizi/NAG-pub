...
ns.AddRotationToDefaults(defaults, CLASS_SPECS.FERAL, "Cataclysm Feral Combat", {
    ...
    rotationString = [[
        ...
        or     (((NAG:IsActive(5217) or (NAG:TimeRemaining() < 11)) and NAG:IsActive(768)) and NAG:Cast(82174))
        or     (((((NAG:AuraRemainingTime(5217) > 5) and (NAG:CurrentHealthPercent() <= 60.0) and (NAG:TimeToReady(50334) > (NAG:TimeRemaining() - 20))) or (NAG:TimeRemaining() <= 26)) and NAG:IsActive(768)) and NAG:Cast(58145))
        or     ((NAG:IsActive(5217) and NAG:IsActive(768)) and NAG:Cast(50334))
        or     ((((NAG:CurrentEnergy() < 50.0) or (NAG:TimeRemaining() < 7) or (NAG:CurrentComboPoints() == 5.0)) and NAG:IsActive(768) and (not NAG:IsActive(50334))) and NAG:Cast(5217))
        ...
        or     (((((not NAG:IsActive(52610)) and (NAG:DotRemainingTime(1079) > 2) and (NAG:CurrentComboPoints() >= 1.0) and (NAG:CurrentComboPoints() <= 2.0)) or ((NAG:CurrentComboPoints() == 5.0) and (NAG:AuraRemainingTime(52610) < 3) and (NAG:DotRemainingTime(1079) > 4))) and (NAG:TimeRemaining() > 5) and NAG:IsActive(768)) and NAG:Cast(52610))
        ...
        or     ((((NAG:DotRemainingTime(1079) > 7) and (NAG:AuraRemainingTime(52610) > 8) and (NAG:CurrentComboPoints() == 5.0) and NAG:IsActive(768)) or (NAG:IsActive(50334) and (NAG:CurrentComboPoints() == 5.0) and (NAG:CurrentEnergy() > 55.0) and NAG:IsActive(768)) or ((NAG:TimeRemaining() < 2) and (NAG:CurrentComboPoints() >= 3.0) and NAG:IsActive(768))) and NAG:Cast(22568))
        ...
        or     (((((NAG:CurrentEnergy() < 80.0) and (not ((NAG:CurrentComboPoints() == 5.0) and (NAG:DotRemainingTime(1079) < 6)))) or (NAG:AuraRemainingTime(5217) <= 2) or (NAG:TimeRemaining() < 2) or NAG:IsActive(5217) or (NAG:AuraRemainingTime(81022) < 2)) and NAG:IsActive(81022) and NAG:IsActive(768)) and NAG:Cast(6785))
        ...
        or     ((NAG:IsActive(5487) and (NAG:DotRemainingTime(770) < 60) and (NAG:DotRemainingTime(770) < NAG:TimeRemaining())) and NAG:Cast(16857))
...
NAG:AutocastOtherCooldowns()
    ...
    or     (((NAG:CurrentEnergy() < 50.0) and (not NAG:IsActive(16870)) and (not NAG:IsReady(5217)) and NAG:IsReady(49376) and (not NAG:IsActive(2825)) and NAG:IsActive(768)) and NAG:Cast(49376))
    or     (((NAG:IsActive(5217) or (NAG:TimeRemaining() < 11)) and NAG:IsActive(768)) and NAG:Cast(82174))
    or     (((((NAG:AuraRemainingTime(5217) > 5) and (NAG:TimeToReady(50334) > (NAG:TimeRemaining() - 20))) or (NAG:TimeRemaining() <= 26)) and NAG:IsActive(768)) and NAG:Cast(58145))
    or     ((NAG:IsActive(5217) and NAG:IsActive(768)) and NAG:Cast(50334))
    or     ((((NAG:CurrentEnergy() < 50.0) or (NAG:TimeRemaining() < 7) or (NAG:CurrentComboPoints() == 5.0)) and NAG:IsActive(768) and (not NAG:IsActive(50334))) and NAG:Cast(5217))
    or     ((NAG:IsActive(16870) and ((NAG:CurrentComboPoints() <= 4.0) and (NAG:CurrentComboPoints() >= 1.0)) and NAG:IsActive(52610) and NAG:IsActive(768)) and NAG:Cast(5221))
