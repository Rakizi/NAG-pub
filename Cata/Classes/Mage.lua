...
local rotationStringMageArcane = [[
        ...
        or (((NAG:DebuffNumStacks(36032) > 3.0) or (NAG:TimeRemaining() < 20)) and NAG:Cast(12042))
        or (((NAG:IsActive(12042) and (not NAG:IsActive(2825))) or (NAG:TimeRemaining() < 20)) and NAG:Cast(26297))
        or ((NAG:IsActive(12042) or (NAG:TimeRemaining() < 25)) and NAG:Cast(58091))
        or (((NAG:IsActive(12042) and (NAG:CurrentManaPercent() < 95)) or (NAG:TimeRemaining() < 20)) and NAG:Cast(36799))
        or (NAG:IsActive(12042) and NAG:Cast(55342))
        or (((not NAG:IsActive(12042)) and (NAG:TimeRemaining() > 25) and (NAG:CurrentManaPercent() < 30)) and NAG:ChannelSpell(12051, function() return (NAG:CurrentManaPercent() >= 80) end, true))
        or ((NAG:TimeRemaining() < NAG:CastTime(30451)) and NAG:Cast(2136))
        or (((((NAG:CurrentMana() / 3333.0) > NAG:TimeRemaining()) and (NAG:CurrentManaPercent() > 10)) or (NAG:TimeToReady(12051) < 25) or (NAG:CurrentManaPercent() > 92) or NAG:IsActive(12042)) and NAG:Cast(30451))
        or NAG:Cast(82731)
...
local rotationStringMageFire = [[
        ...
        or (((NAG:TimeRemainingPercent() > 20.0) and (NAG:CurrentManaPercent() > 25) and (not NAG:IsActive(30482))) and NAG:Cast(30482))
        ...
        or ((((NAG:TimeRemainingPercent() < 5.0) and (NAG:DotNumStacks(12846) > 10000.0) and NAG:DotIsActive(12846) and NAG:DotIsActive(44457))) and NAG:Cast(11129))
        ...
        or ((NAG:CurrentManaPercent() < 30) and NAG:ChannelSpell(12051, function() return ((NAG:CurrentManaPercent() > 20) and (NAG:TimeRemaining() < 20)) end, true))
        or (((NAG:CurrentTime() > 25) and (NAG:CurrentManaPercent() < 90)) and NAG:Cast(36799))
        or (((NAG:TimeRemainingPercent() >= 20.0) and (NAG:CurrentManaPercent() < 10) and (not NAG:IsActive(6117))) and NAG:Cast(6117))
