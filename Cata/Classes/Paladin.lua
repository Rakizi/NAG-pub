...
local rotationStringPaladinRetribution = [[
        ...
        or ((((not NAG:IsActive(84963)) or (NAG:AuraRemainingTime(84963) < 3.5)) and (NAG:TimeRemaining() > 6.0) and (NAG:CurrentTime() >= 12.0) and NAG:IsReady(85696)) and NAG:Cast(84963))
        or ((((not NAG:IsActive(84963)) or (NAG:AuraRemainingTime(84963) < 3.5)) and (not NAG:IsReady(85696)) and (NAG:TimeRemaining() > 6.0) and (not NAG:CanCast(85696))) and NAG:Cast(84963))
        ...
        or (((NAG:TimeToReady(85696) <= 10.0) or (NAG:TimeToReady(85696) >= NAG:TimeRemaining())) and NAG:Cast(86150))
...
local rotationPaladinRetributionAoK = [[
    ...
    or     (((NAG:CurrentHolyPower() < 3.0) and (NAG:NumberTargets() >= 4.0) and NAG:IsActive(20154)) and NAG:Cast(53385))
    or     ((NAG:CurrentHolyPower() < 3.0) and NAG:Cast(35395))
    or     ((((not NAG:IsActive(84963)) or (NAG:AuraRemainingTime(84963) < 1.5)) and (NAG:TimeRemaining() > 6.0) and (NAG:CurrentTime() >= 12.0) and NAG:IsReady(85696) and ((NAG:CurrentHolyPower() >= 1.0) or NAG:IsActive(90174))) and NAG:Cast(84963))
