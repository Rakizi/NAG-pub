...
ns.AddRotationToDefaults(defaults, CLASS_SPECS.SHADOW, "Cataclysm Shadow", {
    ...
    or     ((((not NAG:DotIsActive(34914)) or (NAG:DotRemainingTime(34914) <= 1.0)) and NAG:IsActive(95799) and (NAG:TimeRemaining() >= 9.0)) and NAG:Cast(34914))
    or     ((((not NAG:DotIsActive(589)) or (NAG:DotRemainingTime(589) <= 0.5)) and (NAG:TimeRemaining() >= 14.0)) and NAG:Cast(589))
    -- Hide: or (((not NAG:DotIsActive(589)) or (NAG:DotRemainingTime(589) <= 1.0)) and NAG:Cast(589))
    or     (((not NAG:DotIsActive(2944)) and NAG:IsActive(95799) and (NAG:TimeRemaining() >= 15.0)) and NAG:MultiDot(2944, 1, 0.0))
    ...
    or     (((((NAG:CurrentManaPercent() <= 20.0) and (NAG:TimeRemainingPercent() >= 50.0)) or ((NAG:CurrentManaPercent() <= 10.0) and (NAG:TimeRemainingPercent() >= 25.0))) and NAG:IsReady(47585)) and NAG:Cast(47585))
