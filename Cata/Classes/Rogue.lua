...
local rotationStringRogueAssassination = [[
    (((not NAG:DotIsActive(703)) and (NAG:IsActive(1784) or NAG:IsActive(11327))) and NAG:Cast(703))
        ...
        or (((NAG:DotRemainingTime(1943) <= 2.0) and (NAG:TimeRemaining() >= 2.0) and (NAG:CurrentComboPoints() >= 4.0)) and NAG:Cast(1943))
        or (((not NAG:IsActive(58427)) and (NAG:CurrentComboPoints() < 5.0) and (NAG:CurrentEnergy() >= 45.0)) and NAG:Cast(1856))
        or ((((NAG:CurrentComboPoints() == 5.0) or (NAG:TimeRemaining() <= 5)) and NAG:DotIsActive(79140)) and NAG:Cast(14177))
...
local rotationStringRogueCombat = [[
    ...
    or     (((NAG:CurrentEnergy() <= 40.0) and (((not NAG:IsActive(109949)) and NAG:IsActive(2825)) or (not NAG:IsActive(109949)) or (NAG:TimeRemaining() <= 10.0)) and (NAG:IsActive(84745) or NAG:IsActive(84746) or NAG:IsActive(84747))) and NAG:Cast(82174))
    or     (((NAG:CurrentEnergy() <= 40.0) and (((not NAG:IsActive(109949)) and NAG:IsActive(2825)) or (not NAG:IsActive(109949)) or (NAG:TimeRemaining() <= 10.0)) and (NAG:IsActive(84745) or NAG:IsActive(84746) or NAG:IsActive(84747))) and NAG:Cast(33697))
    or     ((NAG:TimeToReady(51690) > 30) and NAG:Cast(82174))
    or     (((NAG:CurrentEnergy() <= 40.0) and (((not NAG:IsActive(109949)) and NAG:IsActive(2825)) or (not NAG:IsActive(109949)) or (NAG:TimeRemaining() <= 10.0)) and (NAG:IsActive(84745) or NAG:IsActive(84746) or NAG:IsActive(84747))) and NAG:Cast(51690))
    or     (((NAG:TimeToReady(51690) > 15.0) or (NAG:TimeRemaining() <= 20.0)) and NAG:Cast(26297))
    or     ((NAG:TimeToReady(13750) > 30) and NAG:Cast(26297))
    or     ((NAG:TimeToReady(13750) > 30) and NAG:Cast(33697))
    or     (((NAG:TimeToReady(51690) > 15.0) or (NAG:TimeRemaining() <= 20.0)) and NAG:Cast(13750))
    or     (((NAG:TimeToReady(51690) > 15.0) or (NAG:TimeRemaining() <= 20.0)) and NAG:Cast(33697))
...
local rotationStringRogueSubtlety = [[
    ...
    or     (((not NAG:DotIsActive(1943)) and (NAG:CurrentComboPoints() >= 5.0) and (NAG:TimeRemaining() >= 10.0)) and NAG:Cast(1943))
    or     (((NAG:CurrentComboPoints() >= 5.0) and (NAG:DotRemainingTime(1943) <= 8) and NAG:DotIsActive(1943)) and NAG:Cast(2098))
    or     (((NAG:AuraRemainingTime(5171) <= 5.0) and (NAG:CurrentComboPoints() >= 5.0) and (NAG:TimeRemaining() >= 8) and ((NAG:AuraRemainingTime(5171) <= 3.0) or (NAG:CurrentEnergy() <= 30.0)) and (NAG:DotRemainingTime(1943) > 8)) and NAG:Cast(5171))
    or     (((NAG:AuraRemainingTime(73651) <= 6.0) and (NAG:CurrentComboPoints() >= 5.0) and (NAG:TimeRemaining() >= 10.0) and (NAG:DotRemainingTime(1943) > 8)) and NAG:Cast(73651))
    ...
    or     ((NAG:CurrentComboPoints() >= 5.0) and NAG:Cast(2098))
    or     (((NAG:DotRemainingTime(89775) <= 3.0) and (not NAG:IsActive(51713)) and (not NAG:UnitIsStealthed()) and (NAG:TimeRemaining() >= 10.0) and ((NAG:CurrentComboPoints() < 4.0) or ((NAG:CurrentComboPoints() < 5.0) and ((NAG:CurrentEnergy() >= 80.0) or (NAG:AuraInternalCooldown(51699) >= 1.0))))) and NAG:Cast(16511))
