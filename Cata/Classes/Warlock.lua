...
local rotationStringWarlockAffliction = [[
        ...
        or (((NAG:TimeRemaining() > 71) or NAG:IsExecutePhase(25)) and NAG:Cast(82174))
        or (((NAG:TimeRemaining() > 136) or NAG:IsExecutePhase(25)) and NAG:Cast(33697))
        or (((NAG:TimeRemaining() > 141) or NAG:IsExecutePhase(25)) and NAG:Cast(77801))
        or (((NAG:TimeRemaining() <= 26) or NAG:IsExecutePhase(25)) and NAG:Cast(58091))
