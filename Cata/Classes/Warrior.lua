...
or UnitAffectingCombat("player") and (
    ...
    or     (((NAG:IsExecutePhase(20) and (NAG:IsReady(69113) or NAG:IsReady(68972))) or (NAG:IsExecutePhase(20) and (not (NAG:IsKnown(69113) or NAG:IsKnown(68972))) and NAG:IsActive(57519)) or (NAG:TimeRemaining() < 26.5)) and NAG:Cast(NAG:GetBattlePotion()))
    or     ((((NAG:AuraNumStacks(96923) == 5.0) and (NAG:IsReady(69113) or NAG:IsReady(68972)) and (NAG:DotIsActive(86346) or (NAG:TimeToReady(86346) > 6)) and ((NAG:TimeRemaining() > 125) or NAG:IsExecutePhase(20))) or (NAG:TimeRemaining() <= 16.5) or ((NAG:CurrentTime() >= 1.5) and NAG:IsReady(1719))) and NAG:Cast(33697))
    or     (((NAG:AuraNumStacks(96923) == 5.0) and (NAG:DotIsActive(86346) or (NAG:TimeToReady(86346) > 6) or (NAG:TimeRemaining() <= 16.5)) and ((NAG:TimeRemaining() > 125) or NAG:IsExecutePhase(20))) and NAG:Cast(69113))
    or     (((NAG:AuraNumStacks(96923) == 5.0) and (NAG:DotIsActive(86346) or (NAG:TimeToReady(86346) > 6) or (NAG:TimeRemaining() <= 16.5)) and ((NAG:TimeRemaining() > 125) or NAG:IsExecutePhase(20))) and NAG:Cast(68972))
    or     (((NAG:TimeRemaining() > 120) or NAG:IsExecutePhase(20)) and NAG:Cast(59461))
    or     ((((NAG:TimeRemaining() > 130) and (NAG:CurrentTime() >= 1.5)) or NAG:IsExecutePhase(20)) and NAG:Cast(62464))
    or     ((((NAG:TimeRemaining() > 130) and (NAG:CurrentTime() >= 1.5)) or NAG:IsExecutePhase(20)) and NAG:Cast(62469))
    or     ((((NAG:CurrentTime() >= 1.5) and (NAG:TimeRemaining() > 90)) or NAG:IsExecutePhase(20)) and NAG:Cast(77116))
    or     ((((NAG:CurrentTime() >= 1.5) and (NAG:TimeRemaining() > 65)) or NAG:IsExecutePhase(20)) and NAG:Cast(69002))
    ...
    or     ((((NAG:TimeRemaining() > 125) and (not (NAG:IsKnown(69113) or NAG:IsKnown(68972) or (NAG:NumEquippedStatProcTrinkets(6, -1, -1, 110) == 1.0)))) or ((NAG:TimeRemaining() < 125) and NAG:IsExecutePhase(20) and (not (NAG:IsKnown(69113) or NAG:IsKnown(68972) or (NAG:NumEquippedStatProcTrinkets(6, -1, -1, 110) == 1.0)))) or NAG:AnyTrinketStatProcsActive(6, -1, -1, 110)) and NAG:Cast(33697))
    or     ((NAG:CurrentTime() >= 1.5) and NAG:Cast(1719))
    or     ((((NAG:CurrentTime() >= 1.5) and (NAG:TimeRemaining() > 122) and (NAG:TimeToReady(78) < 1.5)) or ((NAG:TimeRemaining() < 122) and NAG:IsExecutePhase(20) and ((NAG:TimeToReady(78) < 1.5) or (NAG:TimeRemaining() < 11)))) and NAG:Cast(85730))
    or     NAG:Cast(1134)
    or     (((NAG:DotIsActive(86346) or ((NAG:TimeToReady(86346) > 5) and (NAG:TimeRemaining() > 60))) and NAG:IsActive(2458)) and NAG:Cast(6544))
    ...
    or     ((NAG:IsActive(99234) and (NAG:TimeRemaining() > 6)) and NAG:Cast(6673))
    or     (((NAG:TimeRemaining() > 1.5) and (not (NAG:IsExecutePhase(20) and (NAG:DotIsActive(86346) or (NAG:IsActive(105907) and (NAG:DotRemainingTime(86346) >= 3))) and NAG:IsActive(57519)))) and NAG:Cast(12294))
...
local rotationStringWarriorFury = [[
        ...
        or ((NAG:IsExecutePhase(20) or (NAG:TimeRemaining() >= 252) or (NAG:TimeRemaining() <= 12)) and NAG:Cast(1719))
        or ((NAG:IsExecutePhase(20) or (NAG:TimeRemaining() >= 174) or (NAG:TimeRemaining() <= 30)) and NAG:Cast(12292))
        or ((NAG:IsExecutePhase(20) or (NAG:TimeRemaining() >= 174) or (NAG:TimeRemaining() <= 30)) and NAG:Cast(33697))
        or NAG:Cast(82174)
