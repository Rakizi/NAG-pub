...
ns.AddRotationToDefaults(defaults,
    SpecializationCompat:GetSpecID("DeathKnight", "Unholy"),
    "DeathKnight Unholy - Default by @Fonsas",
    {
        -- Required parameters
        default = true,
        enabled = true,
        ...
        prePull = {
            { NAG:Cast(48265), -20000 }, { NAG:Cast(42650), -7000 }, { NAG:Cast(57330), -1000 }, { NAG:Cast(76095), -1000 }
        },
        rotationString = [[
...
--[[
--add these lines at the end of the rotation when editing it.
    or     ((((NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneFrost)) and (NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneUnholy)) and (NAG:DotRemainingTime(55095) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood)) and NAG:CurrentRuneDeath(NAG.Types.RuneSlot.SlotLeftBlood) and (NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotLeftBlood) <= NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotRightBlood))) or ((NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneFrost)) and (NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneUnholy)) and (NAG:DotRemainingTime(55095) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood)) and NAG:CurrentRuneDeath(NAG.Types.RuneSlot.SlotRightBlood) and (NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotRightBlood) <= NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotLeftBlood))) or ((NAG:RuneCooldown(NAG.Types.RuneType.RuneFrost) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood)) and (NAG:RuneCooldown(NAG.Types.RuneType.RuneFrost) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneUnholy)) and (NAG:DotRemainingTime(55095) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneFrost)))) and NAG:Cast(45477, 10))
    or     ((((NAG:RuneCooldown(NAG.Types.RuneType.RuneUnholy) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood)) and (NAG:RuneCooldown(NAG.Types.RuneType.RuneUnholy) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneFrost)) and (NAG:DotRemainingTime(55078) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneUnholy))) or ((NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneUnholy)) and (NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneFrost)) and (NAG:DotRemainingTime(55078) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood)) and NAG:CurrentRuneDeath(NAG.Types.RuneSlot.SlotLeftBlood) and (NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotLeftBlood) <= NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotRightBlood))) or ((NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneUnholy)) and (NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneFrost)) and (NAG:DotRemainingTime(55078) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood)) and NAG:CurrentRuneDeath(NAG.Types.RuneSlot.SlotRightBlood) and (NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotRightBlood) <= NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotLeftBlood))) or ((NAG:RuneCooldown(NAG.Types.RuneType.RuneFrost) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneUnholy)) and (NAG:RuneCooldown(NAG.Types.RuneType.RuneFrost) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood)) and (NAG:DotRemainingTime(55078) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneFrost)) and NAG:CurrentRuneDeath(NAG.Types.RuneSlot.SlotRightFrost) and (NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotRightFrost) <= NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotLeftFrost))) or ((NAG:RuneCooldown(NAG.Types.RuneType.RuneFrost) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneUnholy)) and (NAG:RuneCooldown(NAG.Types.RuneType.RuneFrost) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood)) and (NAG:DotRemainingTime(55078) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneFrost)) and NAG:CurrentRuneDeath(NAG.Types.RuneSlot.SlotLeftFrost) and (NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotLeftFrost) <= NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotRightFrost)))) and NAG:Cast(45462, 10))
    or     ((((NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotRightBlood) > NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotLeftBlood)) and NAG:CurrentRuneDeath(NAG.Types.RuneSlot.SlotLeftBlood)) or ((NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotLeftBlood) > NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotRightBlood)) and NAG:CurrentRuneDeath(NAG.Types.RuneSlot.SlotRightBlood)) or ((NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotLeftFrost) > NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotRightFrost)) and NAG:CurrentRuneDeath(NAG.Types.RuneSlot.SlotRightFrost)) or ((NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotRightFrost) > NAG:RuneSlotCooldown(NAG.Types.RuneSlot.SlotLeftFrost)) and NAG:CurrentRuneDeath(NAG.Types.RuneSlot.SlotLeftFrost)) or (NAG:RuneCooldown(NAG.Types.RuneType.RuneUnholy) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneBlood)) or (NAG:RuneCooldown(NAG.Types.RuneType.RuneUnholy) <= NAG:RuneCooldown(NAG.Types.RuneType.RuneFrost))) and NAG:Cast(55090, 10))
    or     NAG:Cast(85948, 10)
        ...
        spells = {33697, 43265, 45462, 45529, 47541, 47568, 49016, 49206, 53365, 55078, 55090, 55095, 57330, 63560, 77575, 81340, 85948, 114851, 114867, 115989, 123693, 126734, 138347},
        items = {76095},
        auras = {},
        runes = {},
...
ns.AddRotationToDefaults(defaults,
    ...
    "Blood - by @Headrippa",
    {
        ...
        or ((UnitHealth("player") / UnitHealthMax("player")) <= 0.4 and (NAG:CurrentRuneCount(2) >= 1 and NAG:CurrentRuneCount(3) >= 1 or NAG:CurrentRuneCount(4) >= 2) and NAG:SpellIsReady(49998)) and NAG:Cast(49998)
        ...
        or (NAG:AuraIsActive(49028) and NAG:SpellIsReady(47568) and (NAG:CurrentRuneCount(2) == 0 and NAG:CurrentRuneCount(3) == 0 or NAG:CurrentRuneCount(4) == 0)) and NAG:Cast(47568)
        ...
        or ((select(2, UnitAttackPower("player")) >= (UnitLevel("player") < 60 and 0 or (200 + (UnitLevel("player") - 60) * 300)) or (UnitHealth("player") / UnitHealthMax("player")) < 0.65) and NAG:SpellTimeToReady(49028) <= 0) and NAG:Cast(49028)
        ...
        or (NAG:IsExecutePhase(35) and not NAG:SpellIsKnown(114866) and NAG:CurrentRunicPower() >= 30 and NAG:SpellIsReady(56815)) and NAG:Cast(56815)
        or (NAG:IsExecutePhase(35) and not NAG:SpellIsKnown(114866) and NAG:CurrentRuneCount(4) >= 1 and NAG:SpellIsReady(49998)) and NAG:Cast(49998)
        or (NAG:IsExecutePhase(35) and not NAG:SpellIsKnown(114866) and NAG:CurrentRuneCount(1) >= 1 and NAG:CurrentHealthPercent() > 0.4 and NAG:CountEnemiesInRange(10) >= 2 and NAG:DotRemainingTime(55078) <= 4 and NAG:SpellIsReady(48721)) and NAG:Cast(48721)
        or (NAG:IsExecutePhase(35) and not NAG:SpellIsKnown(114866) and NAG:CurrentRuneCount(1) >= 1 and NAG:SpellIsReady(55050) and NAG:CurrentRuneCount(2) == 0 and NAG:CurrentRuneCount(3) == 0 and NAG:CurrentRuneCount(4) == 0) and NAG:Cast(55050)
        ...
        or (NAG:CurrentRunicPower() >= 20 and not NAG:IsReadySpell(108196) and NAG:CurrentRunicPower() < 30 and NAG:Cast(56815, 10, 'RIGHT'))
        ...
        -- Serialized JSON for straight APL reading
        --rotation_json = [[[{"action":{"condition":{"cmp":{"op":"OpLe","lhs":{"currentHealthPercent":{}},"rhs":{"const":{"val":"55%"}}}},"castSpell":{"spellId":{"spellId":48743}}}},{"action":{"autocastOtherCooldowns":{}}},{"action":{"condition":{"cmp":{"op":"OpGe","lhs":{"currentTime":{}},"rhs":{"const":{"val":"89s"}}}},"castSpell":{"spellId":{"spellId":48792}}}},{"action":{"condition":{"or":{"vals":[{"cmp":{"op":"OpLe","lhs":{"auraRemainingTime":{"sourceUnit":{"type":"CurrentTarget"},"auraId":{"spellId":55078}}},"rhs":{"const":{"val":"1s"}}}},{"cmp":{"op":"OpLe","lhs":{"auraRemainingTime":{"sourceUnit":{"type":"CurrentTarget"},"auraId":{"spellId":55095}}},"rhs":{"const":{"val":"1s"}}}}]}},"castSpell":{"spellId":{"spellId":77575}}}},{"action":{"condition":{"not":{"val":{"auraIsActive":{"auraId":{"spellId":49222}}}}},"strictSequence":{"actions":[{"castSpell":{"spellId":{"spellId":45529}}},{"castSpell":{"spellId":{"spellId":49222}}}],"name":"someName265"}}},{"action":{"condition":{"cmp":{"op":"OpLe","lhs":{"currentHealthPercent":{}},"rhs":{"const":{"val":"60%"}}}},"castSpell":{"spellId":{"spellId":55233}}}},{"action":{"condition":{"auraIsActive":{"auraId":{"spellId":55233}}},"castSpell":{"spellId":{"spellId":82176}}}},{"action":{"condition":{"auraIsActive":{"auraId":{"spellId":96171}}},"castSpell":{"spellId":{"spellId":48982}}}},{"action":{"condition":{"and":{"vals":[{"cmp":{"op":"OpLe","lhs":{"currentHealthPercent":{}},"rhs":{"const":{"val":"50%"}}}},{"not":{"val":{"spellCanCast":{"spellId":{"spellId":49998,"tag":1}}}}}]}},"castSpell":{"spellId":{"spellId":47568}}}},{"action":{"condition":{"or":{"vals":[{"cmp":{"op":"OpEq","lhs":{"currentRuneCount":{"runeType":"RuneFrost"}},"rhs":{"const":{"val":"2"}}}},{"cmp":{"op":"OpEq","lhs":{"currentRuneCount":{"runeType":"RuneUnholy"}},"rhs":{"const":{"val":"2"}}}},{"cmp":{"op":"OpLe","lhs":{"currentHealthPercent":{}},"rhs":{"const":{"val":"50%"}}}},{"not":{"val":{"auraIsActive":{"auraId":{"spellId":77535}}}}}]}},"castSpell":{"spellId":{"spellId":49998,"tag":1}}}},{"action":{"condition":{"cmp":{"op":"OpGe","lhs":{"currentRunicPower":{}},"rhs":{"const":{"val":"120"}}}},"castSpell":{"spellId":{"spellId":56815}}}},{"action":{"condition":{"and":{"vals":[{"or":{"vals":[{"cmp":{"op":"OpEq","lhs":{"currentRuneCount":{"runeType":"RuneFrost"}},"rhs":{"const":{"val":"1"}}}},{"cmp":{"op":"OpEq","lhs":{"currentRuneCount":{"runeType":"RuneUnholy"}},"rhs":{"const":{"val":"1"}}}},{"cmp":{"op":"OpEq","lhs":{"currentRuneCount":{"runeType":"RuneDeath"}},"rhs":{"const":{"val":"1"}}}}]}},{"not":{"val":{"spellCanCast":{"spellId":{"spellId":49998,"tag":1}}}}}]}},"castSpell":{"spellId":{"spellId":45529}}}},{"action":{"castSpell":{"spellId":{"spellId":49998,"tag":1}}}},{"action":{"condition":{"not":{"val":{"auraIsActive":{"auraId":{"spellId":81256}}}}},"castSpell":{"spellId":{"spellId":46584}}}},{"action":{"condition":{"and":{"vals":[{"cmp":{"op":"OpLe","lhs":{"currentHealthPercent":{}},"rhs":{"const":{"val":"80%"}}}},{"cmp":{"op":"OpEq","lhs":{"currentRuneCount":{"runeType":"RuneBlood"}},"rhs":{"const":{"val":"2"}}}}]}},"castSpell":{"spellId":{"spellId":48982}}}},{"action":{"condition":{"auraIsActive":{"auraId":{"spellId":81141}}},"castSpell":{"spellId":{"spellId":48721}}}},{"action":{"condition":{"cmp":{"op":"OpEq","lhs":{"currentNonDeathRuneCount":{"runeType":"RuneBlood"}},"rhs":{"const":{"val":"2"}}}},"castSpell":{"spellId":{"spellId":55050}}}},{"action":{"castSpell":{"spellId":{"spellId":56815}}}},{"action":{"castSpell":{"spellId":{"spellId":57330}}}}]]],
        --prepull_json = [[[{"action":{"castSpell":{"spellId":{"spellId":48263}}},"doAtValue":{"const":{"val":"-31s"}}},{"action":{"castSpell":{"spellId":{"spellId":49222}}},"doAtValue":{"const":{"val":"-30s"}}},{"action":{"castSpell":{"spellId":{"spellId":57330}}},"doAtValue":{"const":{"val":"-1.5s"}}},{"action":{"castSpell":{"spellId":{"otherId":"OtherActionPotion"}}},"doAtValue":{"const":{"val":"-1s"}}}]]]
    }
)
