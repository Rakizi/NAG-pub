...
ns.AddRotationToDefaults(defaults,
    ...
    ((not NAG:AuraIsActive(31801)) and (NAG:NumberTargets() <= 3)) and NAG:Cast(31801)
        ...
        or ((NAG:SpellTimeToReady(53595) <= NAG:SpellTimeToReady(879)) and (NAG:SpellTimeToReady(53595) <= NAG:SpellTimeToReady(20271)) and ((NAG:IsExecutePhase(20) or NAG:AuraIsActive(31884)) and (NAG:SpellTimeToReady(53595) <= NAG:SpellTimeToReady(24275))) and (NAG:NumberTargets() >= 4) and (NAG:CurrentGenericResource() < 3)) and NAG:Cast(53595, 10)
        or ((NAG:SpellTimeToReady(35395) <= NAG:SpellTimeToReady(879)) and (NAG:SpellTimeToReady(35395) <= NAG:SpellTimeToReady(20271)) and ((NAG:IsExecutePhase(20) or NAG:AuraIsActive(31884)) and (NAG:SpellTimeToReady(35395) <= NAG:SpellTimeToReady(24275))) and (NAG:NumberTargets() <= 3) and (NAG:CurrentGenericResource() < 3)) and NAG:Cast(35395, 10)
        or ((NAG:SpellTimeToReady(20271) < NAG:SpellTimeToReady(35395)) and (NAG:SpellTimeToReady(20271) < NAG:SpellTimeToReady(879)) and ((NAG:IsExecutePhase(20) or NAG:AuraIsActive(31884)) and (NAG:SpellTimeToReady(35395) < NAG:SpellTimeToReady(24275))) and (NAG:CurrentGenericResource() < 3)) and NAG:Cast(20271, 10)
        ]],
