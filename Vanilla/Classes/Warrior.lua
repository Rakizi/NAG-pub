...
ns.AddRotationToDefaults(defaults,
    ...
    or     NAG:Cast(10646)
    or     NAG:Cast(18641)
    or     (((NAG:TimeRemaining() <= 30) or (NAG:TimeRemaining() >= 211.5)) and NAG:Cast(12328))
    or     (false and NAG:Cast(1719))
    -- Hide: or ((NAG:TimeRemaining() <= 15) and NAG:Cast(1719))
    or     (((NAG:TimeRemaining() <= 20) or (NAG:TimeRemaining() >= 140)) and NAG:Cast(NAG:GetBattlePotion()))
    or     (((NAG:TimeRemaining() <= 20) or (NAG:TimeRemaining() >= 141.5)) and NAG:Cast(20572))
    or     ((NAG:TimeRemaining() <= 60) and NAG:Cast(24427))
    or     (((NAG:TimeRemaining() <= 30) or (NAG:TimeRemaining() >= 130)) and NAG:Cast(21180))
    or     (((NAG:TimeRemaining() <= 30) or (NAG:TimeRemaining() >= 130)) and NAG:Cast(29602))
    or     (((NAG:TimeRemaining() <= 30) or (NAG:TimeRemaining() >= 130)) and NAG:Cast(23041))
    or     (((NAG:TimeRemaining() <= 30) or (NAG:TimeRemaining() >= 130)) and NAG:Cast(23041))
    or     (((NAG:TimeRemaining() <= 30) or (NAG:TimeRemaining() >= 140)) and NAG:AutocastOtherCooldowns())
...
ns.AddRotationToDefaults(defaults,
    ...
    or     ((NAG:TimeRemaining() <= 15) and NAG:Cast(1719))
    or     (((NAG:TimeRemaining() <= 20) or (NAG:TimeRemaining() >= 140)) and NAG:Cast(NAG:GetBattlePotion()))
    or     (((NAG:TimeRemaining() <= 20) or (NAG:TimeRemaining() >= 141.5)) and NAG:Cast(20572))
    or     ((NAG:TimeRemaining() <= 60) and NAG:Cast(24427))
    or     (((NAG:TimeRemaining() <= 30) or (NAG:TimeRemaining() >= 130)) and NAG:Cast(21180))
